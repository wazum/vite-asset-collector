...
final class AssetViewHelper extends AbstractViewHelper implements ViewHelperNodeInitializedEventInterface
{
    ...
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument(
            'preloadModules',
            'boolean',
            'If set to "true", <link rel="modulepreload"> tags are added for all JavaScript chunks that are statically imported by the entry point (production mode only). Combine with priority="1" to render the entry script next to the preload tags in the HTML head.',
            false,
            false
        );
